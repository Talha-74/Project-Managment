                                        ...
                                        {projects.data.map((project) => (
                                            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                                ...
                                                <th className="px-3 py-3 text-nowrap">
                                                    <Link href={route("project.show", project.id)} className="font-medium text-grey-600 dark:text-grey-500 hover:underline">
                                                    {project.name}
                                                    </Link>
                                                    </th>
                                                <td className="px-3 py-3">
                                                ...
                                                <td className="px-3 py-3">
                                                    <Link href="{ruote('project.edit', project.id)}" className="font-medium text-blue-600 dark:text-blue-500 hover:underline mx-1">
                                                        Edit
                                                    </Link>
                                                    <Link href="{ruote('project.delete', project.id)}" className="font-medium text-red-600 dark:text-red-500 hover:underline mx-1">
                                                        Delete
                                                    </Link>
                                                </td>
                                            </tr>
